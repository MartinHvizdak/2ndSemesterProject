...
public class DBCustomerEmployee implements IDBCustomerEmployee{
    ...
    @Override
    public ArrayList<CustomerEmployee> retrieveAllEmployees() throws DBException{
        Connection con = DBConnection.getInstance().getDBcon();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                employees.add(new CustomerEmployee(employeePersonalID, employeeFirstName, employeeSecondName, employeeSalary, employeeGeneratedIncome));
            }
